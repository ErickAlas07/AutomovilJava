...
public class Automovil implements Comparable<Automovil>{
    ...
    private static Color colorPatente = Color.NARAJA;
    private static int capacidadEstanqueEstatico = 30;
    private static int ultimoId;

    private static final Integer VELOCIDAD_MAX_CARRETERA = 120;
    private static final Integer VELOCIDAD_MAX_CIUDAD = 60;
    ...
    public String acelerar (int rpm) {
        return "El automóvil " + this.fabricante + " acelerando a " + rpm + " rpm";
    }
